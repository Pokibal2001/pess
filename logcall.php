...
function validateForm()
{
	...
	if (x==null || x=="")
  	...
  	// add the code to validate other inputs
}
</script>
...
function validateForm()
{
	...
	if (x==null || x=="")
  	...
  	// add thecode to validate other inputs
}
</script>
...
<table>
  ...
  <tr>
    <td>Incident Type :</td>
    <td>
      <select name="incidentType" id="incidentType"><?php // populate combo box with $incidentType
